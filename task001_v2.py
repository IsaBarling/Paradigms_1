...
x_simple = np.array([10, 22, 33, 14, 25, 37, 7])

y_simple = np.array([16, 27, 38, 19, 25, 16, 17])

numpy_check = np.corrcoef(x_simple, y_simple)

print("\nКоэффициенты корреляции Пирсона и момента указанных массивов:\n", numpy_check)
